...
HD_PWD='C:/Users/natal/OneDrive/Dokumenty/szkola/vivado/artix7_bcd/artix7_bcd.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log artix7_bcd.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source artix7_bcd.tcl
