...
HD_PWD='C:/Users/natal/OneDrive/Dokumenty/szkola/vivado/artix7_bcd/artix7_bcd.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log artix7_bcd.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source artix7_bcd.tcl -notrace
